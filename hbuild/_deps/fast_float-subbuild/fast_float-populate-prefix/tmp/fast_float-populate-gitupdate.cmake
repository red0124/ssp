...
execute_process(
  COMMAND "/usr/bin/git" show-ref "origin/meson"
  WORKING_DIRECTORY "/home/ado/git/ssp/hbuild/_deps/fast_float-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "origin/meson")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("origin/meson" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/origin/meson")
